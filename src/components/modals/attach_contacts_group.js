...
const AttachContactsGroupModal = ({
  selectedContactIds,
  attachContactsGroupModal,
  closeAttachContactsGroupModal,
  app_id,
  appId,
}) => {
  ...
  return (
    <>
      ...
      />
      <Modal
        open={attachContactsGroupModal}
        sx={{ border: "none", boxShadow: "none" }}
        onClose={closeAttachContactsGroupModal}
      >
        <div>
          <Box sx={style}>
...
export default AttachContactsGroupModal;
